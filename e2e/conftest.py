...
async def client(act_command: list[str], wasm_path: Path):
    ...
    transport = StdioTransport(
        ...
        keep_alive=False,  # encoding is pure/stateless — findings Q3: fresh process is the safe default
        log_file=LOG_FILE,
    )
...
def expect_error():
    ...
    payload at `exc.error.data`. Session-lifecycle tests reach it; encode/decode
